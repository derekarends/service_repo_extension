...
using ThinkovatorInc.AddClassTemplate;

namespace AddClassTemplate_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new AddClassTemplatePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(ThinkovatorInc.AddClassTemplate.GuidList.guidAddClassTemplateCmdSet, (int)ThinkovatorInc.AddClassTemplate.PkgCmdIDList.cmdidAddClassTemplate);
