...
namespace AddClassTemplate_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(ThinkovatorInc.AddClassTemplate.GuidList.guidAddClassTemplateCmdSet, (int)ThinkovatorInc.AddClassTemplate.PkgCmdIDList.cmdidAddClassTemplate);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Add ClassTemplate", "ThinkovatorInc.AddClassTemplate.AddClassTemplatePackage");
